...
def check_guess(guessed_num, num_to_check, lives_left):
...
while lives > 0 and guess != number_to_guess:
    #take guess as an input, converting to an integer
...
#run earlier checking function to remove life and print higher/lower info
    check_guess(guess, number_to_guess, lives)
    lives = check_guess(guess, number_to_guess, lives)
